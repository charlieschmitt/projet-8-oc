...
describe('controller', function () {
	...
	it('should show entries on start-up', function () {
		...
		subject.setView('');
		// On vérifie que le rendu affiche bien une todo vide
	...
	describe('routing', function () {
		...
		it('should show active entries', function () {
			...
			// On vérifie que le rendu affiche bien les todos actives
			expect(view.render).toHaveBeenCalledWith('showEntries', [todo]);
		});
		...
		it('should show completed entries', function () {
			...
			// On vérifie que le rendu affiche bien les todos terminées
			expect(view.render).toHaveBeenCalledWith('showEntries', [todo]);
		});
	});
	...
	it('should highlight "All" filter by default', function () {
		...
		subject.setView('#/');
		// On vérifie que le rendu affiche bien la page actuelle, de base
	...
	it('should highlight "Active" filter when switching to active view', function () {
		...
		*/
		...
		// On vérifie que le rendu affiche bien la page avec les todos actives
	...
	it('should highlight "Completed" filter when switching to completed view', function () {
		...
		// On vérifie que le rendu affiche bien la page avec les todos terminées
	...
	describe('toggle all', function () {
		...
		it('should toggle all todos to completed', function () {
			...
			// On met à jour le model pour voir si les todos sont bien terminées
	...
	describe('new todo', function () {
		...
		it('should add a new todo to the model', function () {
			...
			*/
			...
			//expect(model.create).toHaveBeenCalledWith( { title: 'my todo', completed: false }, jasmine.any(Function) );
	...
	describe('element removal', function () {
		...
		it('should remove an entry from the model', function () {
			...
			// expect(model.remove).toHaveBeenCalledWith('removeItem', 1);
